...
subset.cpp - {0~n-1}的所有子集：增量構造法
subset2.cpp - {0~n-1}的所有子集：位向量法
subset3.cpp - {0~n-1}的所有子集：二進位法
nqueen_slow.cpp - n皇后問題：生成-測試法
nqueen.cpp - n皇后問題：普通回溯法
nqueen2.cpp - n皇后問題：優化的回溯法
8.cpp - 八皇后，使用STL集合（最好寫）
8b.cpp - 八皇后，使用雜湊表（競賽中最常用）
8c.cpp - 八皇后，使用全排列的編碼/解碼（最高效）
8a.in - 八皇后，有解輸入資料
8b.in - 八皇后，無解輸入資料
egypt.cpp - 埃及分數問題
